...
import static org.firstinspires.ftc.teamcode.drive.writtenCode.Autonomii.AutoPreloadBB.STROBOT.END_AUTO;
import static org.firstinspires.ftc.teamcode.drive.writtenCode.Autonomii.AutoPreloadBB.STROBOT.PARK;
import static org.firstinspires.ftc.teamcode.drive.writtenCode.Autonomii.AutoPreloadBB.STROBOT.PLACE_PURPLE_PIXEL;
import static org.firstinspires.ftc.teamcode.drive.writtenCode.Autonomii.AutoPreloadBB.STROBOT.PLACE_SPIKE_BACKDROP;
import static org.firstinspires.ftc.teamcode.drive.writtenCode.Autonomii.AutoPreloadBB.STROBOT.RETRACT_LIFT;
import static org.firstinspires.ftc.teamcode.drive.writtenCode.Autonomii.AutoPreloadBB.STROBOT.WAIT_FOR_PURPLE_PIXEL;
...
public class AutoPreloadBB extends LinearOpMode {

    public static final double PRELOAD_LEFT_X = 8;
    public static final double PRELOAD_LEFT_Y = -37;
    public static final double PRELOAD_ANGLE_LEFT = 180;
    public static final double PLACE_SPIKE_LEFT_X = 50;
    public static final double PLACE_SPIKE_LEFT_Y = -27;
    public static final double ANGLE_SPIKE_LEFT = 180;
    public static final double PARK_LEFT_X = 46;
    public static final double PARK_LEFT_Y = -20;
    public static final double ANGLE_PARK_LEFT = 180;
    public static final int PRELOAD_MID_X = 23;
    public static final int PRELOAD_MID_Y = -23;
    public static final int PRELOAD_ANGLE_MID = 180;
    public static final int PLACE_SPIKE_MID_X = 47;
    public static final int PLACE_SPIKE_MID_Y = -33;
    public static final int ANGLE_SPIKE_MID = 180;
    public static final int PARK_MID_X = 43;
    public static final int PARK_MID_Y = -20;
    public static final int ANGLE_PARK_MID = 180;
    public static final int PRELOAD_RIGHT_X = 30;
    public static final int PRELOAD_RIGHT_Y = -35;
    public static final int PRELOAD_ANGLE_RIGHT = 180;
    public static final int PLACE_SPIKE_RIGHT_X = 47;
    public static final int PLACE_SPIKE_RIGHT_Y = -40;
    public static final int ANGLE_SPIKE_RIGHT = 180;
    public static final int PARK_RIGHT_X = 43;
    public static final int PARK_RIGHT_Y = -20;
    public static final int ANGLE_PARK_RIGHT = 180;
